...
# Korea Curriculum Hub

## Summary

한국 수학 교육과정은 `중1~중3 학년형 구조`와 `고교 과목형 구조`가 뚜렷하게 이어지는 허브다. 개념 재등장은 [common-math-1.md](./concept-cards/common-math-1.md), [korean-algebra-course.md](./concept-cards/korean-algebra-course.md), [calculus-1.md](./concept-cards/calculus-1.md), [probability-and-statistics-course.md](./concept-cards/probability-and-statistics-course.md), [korean-geometry-course.md](./concept-cards/korean-geometry-course.md)를 축으로 읽는 것이 가장 안정적이다.
...
- 과목 구조 비교는 [course-track-hub.md](./course-track-hub.md)를 본다.
- 국가 간 비교는 [cross-country-function-progression.md](./cross-country-function-progression.md), [cross-country-geometry-and-proof.md](./cross-country-geometry-and-proof.md), [cross-country-statistics-and-data.md](./cross-country-statistics-and-data.md)로 이어진다.
